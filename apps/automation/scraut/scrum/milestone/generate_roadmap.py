"""
scrum/milestone/generate_roadmap.py
...
from scraut.platform.llm.prompts import ROADMAP_GENERATION, SYSTEM_SCRUM_ASSISTANT
...
def generate_roadmap(breakdown_path: str, milestone_dir: str, constraints: dict,
    ...
    if planning_issue:
        ...
        summary = (
            ...
            f"`python apps/automation/scraut/scrum/milestone/create_sprint_issues.py "
