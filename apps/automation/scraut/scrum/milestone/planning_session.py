"""
scrum/milestone/planning_session.py
...
from scraut.scrum.milestone.generate_roadmap import generate_roadmap
...
def find_milestone_dir(issue_body: str, repo_root: Path) -> Path | None:
    ...
    if match:
        ...
        candidate = get_scraut_root() / "milestones" / milestone_id
        if candidate.exists():
            return candidate
    return None
