"""
scrum/sprint/create_planning_pr.py
...
from scraut.platform.llm.prompts import SPRINT_GOAL_SUGGESTION, SYSTEM_SCRUM_ASSISTANT
...
def create_planning_pr(sprint_num: int, repo_name: str, config: dict) -> None:
    ...
    prev_meta = ""
    if sprint_num > 1:
        prev_meta = read_file(get_sprint_folder(sprint_num - 1) / "meta.md") or ""
