"""test/unit/test_velocity.py"""
import pytest
from unittest.mock import patch
from scraut.scrum.sprint.calculate_velocity import (
...
def test_calculate_sprint_velocity_counts_closed_sp(mock_repo):
    ...
    with patch("scraut.scrum.sprint.calculate_velocity.get_github_client") as mock_g:
