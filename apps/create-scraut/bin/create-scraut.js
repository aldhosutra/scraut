...
async function main() {
  ...
  const dirs = [
    ...
    'apps/automation/scraut/platform/llm', 'apps/automation/scraut/platform/github', 'apps/automation/scraut/scrum/sprint',
    'apps/automation/scraut/scrum/standup', 'apps/automation/scraut/scrum/backlog', 'apps/automation/scraut/scrum/reports',
    'apps/automation/scraut/scrum/repo_sync', 'apps/automation/scraut/scrum/milestone', 'apps/automation/scraut/scrum/visibility',
    'apps/automation/scraut/scrum/suggestions', 'apps/automation/scraut/platform/notifications', 'apps/automation/scraut/scrum/agents',
    'apps/automation/scraut/platform/utils', 'apps/automation/scraut/platform/setup',
    '.scraut/suggestions/active', '.scraut/suggestions/implemented', '.scraut/suggestions/resolved',
    '.scraut/insights', 'workspace/team', 'workspace/okr', 'workspace/customer',
    'workspace/knowledge', 'workspace/milestones', 'apps/portal',
  ];
  ...
  console.log(chalk.bold('📋 Next steps:\n') +
    ...
    '  3. Run: ' + chalk.cyan(`python apps/automation/scraut/platform/setup/create_labels.py ${answers.repo}`) + '\n' +
    '  4. Run: ' + chalk.cyan(`python apps/automation/scraut/scrum/sprint/create_sprint.py --sprint 1 --repo ${answers.repo}`) + '\n' +
