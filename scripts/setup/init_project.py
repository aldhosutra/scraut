...
def main(repo_name: str, config_path: str = None, dry_run: bool = False):
    ...
    logger.info("2. Run: python scripts/setup/create_labels.py --repo [org/repo]")
    logger.info("3. Create first sprint: python scripts/sprint/create_sprint.py --sprint 1 --repo [org/repo]")
